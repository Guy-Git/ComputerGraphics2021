...
private:
	...
	void DrawFlatTriangle(const std::vector<glm::vec3>& vertexPositions, int faceID, MeshModel& currentModel, Scene& scene, glm::vec3 modelPoint, glm::vec3 lightPoint, glm::vec3 faceNormal);
